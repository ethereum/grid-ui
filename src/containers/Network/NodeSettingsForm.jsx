...
import { Button, Input, FileChooser, Select, NetworkChooser } from 'ethereum-react-components'
  ...
  render(){
    ...
    return (
        <form style={{
          ...
          <div className="setting" style={{display: 'inline-block', marginLeft: 10}}>
            Syncmode: <br />
            <div
              style={{width: '300px'}}
            >
          ...
          <div className="setting">
            <span>Running: {isRunning 
              ? <span style={{color: 'green'}}>true</span> 
              : <span style={{color: 'red'}}>false</span>
            }</span>
            <Button flat onClick={() => this.handleStartStop(isRunning)}>{isRunning ? 'stop' : 'start'}</Button>
          </div>
